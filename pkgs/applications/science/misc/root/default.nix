...
'';
  ...
  src = fetchurl {
    ...
    hash = "sha256-cPf4agzV4/Kgvv3FmULdUBQNmQqyZOjlbH8X9r/pyWU=";
  };
  ...
  patches = [
    ...
    # https://github.com/root-project/root/pull/12153
    (fetchpatch {
      url = "https://github.com/root-project/root/commit/28d91b3b8cd76d88d443640a396f43d86dc49f66.diff";
      hash = "sha256-zi0yS8WjdDcckZwS5dAAAp2wd5x47vUmYeK093/RtBw=";
    })

    # needed for next patch to apply
    (fetchpatch {
      url = "https://github.com/root-project/root/commit/c58e55178de95e757064136d9fecad74f7357e52.diff";
      hash = "sha256-Zhssh+ar9EWL0+6yEv6bGEZoDAzZiG84y2hK8i5TABE=";
    })

    # https://github.com/root-project/root/pull/13420
    (fetchpatch {
      url = "https://github.com/root-project/root/commit/92807f3591c25266ad9145045ef062527eea732a.diff";
      hash = "sha256-po6iLxnrxCqCfT8MBZDtlUAWLvVuWSTm84JpjolJCaQ=";
    })
